...
public class Show_Trains extends JFrame{  
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    String str = "select pnr_no,ticket_id,id,jny_date,jny_time,src,dst from ShowCase where src = '"+src+"' and dst = '"+dst+"'";//ShowCase is the name of our database
                    ResultSet rs=c.s.executeQuery(str);
                    
                    if(rs.next()){
                        table.setModel(DbUtils.resultSetToTableModel(rs));
                    }else{
                        JOptionPane.showMessageDialog(null,"No Trains available between Source and Destination");
